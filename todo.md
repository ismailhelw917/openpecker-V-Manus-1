...
## Round 67 - Leaderboard Online Count & Home Page Pricing
- [x] Fix leaderboard to use mock online count instead of page activity count
- [x] Add €49.99 lifetime option to home page upgrade button
- [x] Update handleUpgradeToPremium to support both monthly and lifetime plans
- [x] Display both €4.99/month and €49.99 Lifetime buttons on home page
- [x] Verify mock online count is working (5/5 tests passing)
- [x] Verify leaderboard endpoint updated to use getMockOnlineCount
