      ...
      <Card className="bg-slate-900/50 border-teal-900/30 w-full max-w-md p-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-2">
            Master chess openings through deliberate repetition
          </p>
        </div>
        ...
        <div className="mt-6 p-4 bg-slate-800/50 rounded border border-slate-700">
          <p className="text-xs text-slate-400">
            <strong>First time?</strong> Click "Sign In with Manus" to create a new account or sign in with your existing Manus account.
          </p>
        </div>
      </Card>
    </div>
