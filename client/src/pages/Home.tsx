...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-3 sm:px-4 py-6 sm:py-8 pb-24">
      {/* Hero Section */}
      <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-12">
        ...
        <div className="mb-6 sm:mb-8 flex justify-center">
          <img
            ...
            alt="OpenPecker Logo"
            className="w-64 sm:w-80 md:w-96 object-contain rounded-xl shadow-lg"
          />
        </div>
          ...
          {!isAuthenticated ? (
            <div className="space-y-2">
              ...
              <a
                ...
                className="w-full max-w-sm bg-white hover:bg-gray-50 text-slate-900 border-2 border-slate-300 font-semibold py-3 rounded-lg flex items-center justify-center gap-2 transition-all mx-auto"
                style={{
      ...
      <div className="mt-8 sm:mt-16 max-w-2xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 w-full">
        ...
        <Card className="bg-teal-50 border-teal-200 p-4">
          <h3 className="text-teal-700 font-bold mb-2 text-sm md:text-base">Customizable</h3>
          <p className="text-slate-700 text-sm">
